...
const Setting = () => {
    const { menu, theme, layout, semidark, rtlClass, navbar, animation, toggleAnimation, toggleLayout, toggleMenu, toggleNavbar, toggleRTL, toggleTheme, toggleSemidark } = useTheme();
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3">
                            <button type="button" className={`${theme === 'light' ? 'btn-primary' : 'btn-outline-primary'} btn`} onClick={() => toggleTheme('light')}>
                                <IconSun className="w-5 h-5 shrink-0 ltr:mr-2 rtl:ml-2" />
                                Light
                            </button>

                            <button type="button" className={`${theme === 'dark' ? 'btn-primary' : 'btn-outline-primary'} btn`} onClick={() => toggleTheme('dark')}>
                                <IconMoon className="w-5 h-5 shrink-0 ltr:mr-2 rtl:ml-2" />
                                Dark
                            </button>

                            <button type="button" className={`${theme === 'system' ? 'btn-primary' : 'btn-outline-primary'} btn`} onClick={() => toggleTheme('system')}>
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3">
                            <button type="button" className={`${menu === 'horizontal' ? 'btn-primary' : 'btn-outline-primary'} btn`} onClick={() => toggleMenu('horizontal')}>
                                Horizontal
                            </button>

                            <button type="button" className={`${menu === 'vertical' ? 'btn-primary' : 'btn-outline-primary'} btn`} onClick={() => toggleMenu('vertical')}>
                                Vertical
                            </button>
                        ...
                        <div className="mt-5 text-primary">
                            <label className="inline-flex mb-0">
                                <input
                                    ...
                                    onChange={(e) => toggleSemidark(e.target.checked)}
                                />
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                            ...
                            <button type="button" className={`${layout === 'full' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`} onClick={() => toggleLayout('full')}>
                                Full
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                            <button type="button" className={`${rtlClass === 'ltr' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`} onClick={() => toggleRTL('ltr')}>
                                LTR
                            </button>

                            <button type="button" className={`${rtlClass === 'rtl' ? 'btn-primary' : 'btn-outline-primary'} btn flex-auto`} onClick={() => toggleRTL('rtl')}>
                                RTL
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        ...
                        <div className="mt-3">
                            <select className="form-select border-primary text-primary" value={animation} onChange={(e) => toggleAnimation(e.target.value)}>
