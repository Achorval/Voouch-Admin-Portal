...
const DefaultLayout = ({ children }: PropsWithChildren) => {
    const { sidebar, menu, layout, rtlClass, navbar, animation, toggleSidebar } = useTheme();
    ...
    return (
        <div className={`${sidebar ? 'toggle-sidebar' : ''} ${menu} ${layout} ${rtlClass} main-section antialiased relative font-nunito text-sm font-normal`}>
