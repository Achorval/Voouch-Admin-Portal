...
const Header = () => {
    ...
    const { menu, theme, rtlClass, semidark, locale, toggleRTL, toggleTheme, toggleSidebar } = useTheme();
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo-icon.png" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">VOOUCH</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            ...
                            >
                                <MagnifyingGlassIcon className="w-4.5 h-4.5 mx-auto dark:text-[#d0d2d6]" />
                            </button>
                        </div>
                        <div>
                            {theme === 'light' ? (
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                ...
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                button={<EnvelopeIcon className="w-5 h-5" />}
                            >
                                        ...
                                        <>
                                            ...
                                            <li className="border-t border-white-light text-center dark:border-white/10 mt-5">
                                                <button type="button" className="text-primary font-semibold group dark:text-gray-400 justify-center !py-4 !h-[48px]">
                                                    ...
                                                    <ArrowLongRightIcon className="group-hover:translate-x-1 transition duration-300 ltr:ml-1 rtl:mr-1 w-5 h-5" />
                                                </button>
                                            </li>
                                        </>
                                    ) : (
                        ...
                        <div className="dropdown shrink-0 flex">
                            ...
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 className="text-base">
                                                    ...
                                                    <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">{currentUser?.role}</span>
                                                </h4>
                                    ...
                                    <li>
                                        <Link to="/app/settings/profile" className="dark:hover:text-white">
                                            <UserIcon className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                                            Profile
                                        </Link>
                                    </li>
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <button type="button" className="text-danger !py-3" onClick={() => signOut()}>
                                            <ArrowLeftStartOnRectangleIcon className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 rotate-180 shrink-0" />
                                            Sign Out
                                        </button>
                                    </li>
                                </ul>
