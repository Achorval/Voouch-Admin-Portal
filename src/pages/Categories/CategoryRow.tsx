...
import { useDeleteCategory, useToggleCategoryStatus } from '@/hooks/useCategories';
        ...
        <tr>
            ...
            <td className="text-center">
                <ul className="flex items-center justify-center gap-2">
                    ...
                    <li>
                        <Tippy content={category.isEnabled ? "Disable" : "Enable"}>
                            <button type="button" onClick={handleToggleStatus}>
                                {category.isEnabled ? <NoSymbolIcon className="w-5 h-5 text-primary" /> : <CheckCircleIcon className="w-5 h-5 text-primary" />}
                            </button>
                        </Tippy>
                    </li>
                    <li>
