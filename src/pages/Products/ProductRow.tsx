// src/pages/products/ProductRow.tsx
        ...
        <tr>
            ...
            <td className="text-center">
                <ul className="flex items-center justify-center gap-2">
                    ...
                    <li>
                        <Tippy content={product.isEnabled ? "Disable" : "Enable"}>
                            <button type="button" onClick={handleToggleStatus}>
                                {product.isEnabled ? <NoSymbolIcon className="w-5 h-5 text-primary" /> : <CheckCircleIcon className="w-5 h-5 text-primary" />}
                            </button>
                        </Tippy>
                    </li>
                    <li>
